...
<html lang="es">
  <head>
    ...
    <link rel="canonical" href="css/offcanvas.css">
  ...
  <body class="bg-light">
    ...
    <img class="img-thumbnail" src="img/TrabajemosJuntosJuventud.png" alt="" width="45" height="45" style="margin-right:9px;"> 
  <a class="navbar-brand mr-auto mr-lg-0" href="#">INJUVENTUD | Webinar</a>
...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-4">Webinars</h1>
    <p class="lead">Instituto de la Juventud del Estado de Zacatecas</p>
  <!-- <img src="img/fondo_psic_02.jpg" class="img-fluid" alt="Responsive image"> -->
